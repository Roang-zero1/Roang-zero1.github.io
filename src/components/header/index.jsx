...
const classes = {
  ...
  name: 'text-5xl dark:text-morbius-600 font-bold leading-tight hover:text-black',
  description: 'dark:text-morbius-200',
  list: 'mt-6 uppercase tracking-wider',
  item: 'inline list-none pr-4',
  link:
    'inline-block py-2 font-semibold text-xs dark:text-vanHelsing-600 hover:text-black',
};
